 ...
 * Name file: hero
 *
 * Description: loads 'hero' section template-part for homepage
 *
 * @package WordPress
...
<section class="hero">
	<?php if(checked(1, get_option('add_image_hero_homepage'), false)): ?>
        <div class="hero-bg" style="background-image: url(<?php echo get_option('image_hero_homepage') ?>)">
            <div class="filter">
				<?php if((checked(1, get_option('add_logo_hero_homepage'), false)) &&  (checked(1, get_option('add_message_hero_homepage'), false))): ?>
				...
				<?php elseif (checked(1, get_option('add_logo_hero_homepage'), false)): ?>
                    <div class="jumb-hero">
                        <img src="<?php echo get_option('img_logo')?>"
                             class="logo"
